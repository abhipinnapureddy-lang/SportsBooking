...
const { listTournaments, getTournament, createTournament, registerTeam, createMatch, updateMatch, issueCertificate } = require('../controllers/tournamentController');
...
router.post('/:id/certificates', authenticate, authorizeRoles('admin', 'coordinator'), issueCertificate);
