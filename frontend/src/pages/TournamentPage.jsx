...
import { createTournament, fetchSports, fetchTournament, fetchTournaments, registerTournamentTeam } from '../api.js';
...
function TournamentPage() {
  ...
  return <div className="module-page">
    <section className="module-heading"><div><p className="eyebrow">Tournament management</p><h2>Campus tournaments</h2><p>Create tournaments, register teams, review fixtures and results.</p></div></section>
